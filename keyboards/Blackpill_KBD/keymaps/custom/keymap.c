...
[_QWERTY] = LAYOUT_ortho_5x15(
    ...
    KC_LCTL,     KC_SEC,  KC_LGUI,  KC_LALT,  KC_NO,       KC_SPC,  KC_NO,   KC_SPC,    KC_NO,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_RCTL,  KC_NO),
//              ^^^^^^^^----sends to second 
...
[_LOWER] = LAYOUT_ortho_5x15( 
    ...
    KC_PWR, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN3, KC_MS_L, KC_MS_D,  ),
